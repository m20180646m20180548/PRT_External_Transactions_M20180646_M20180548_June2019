...
ui <- fluidPage(#theme="bootstrap.css"
  ...
  navbarPage(title = '',
              tabPanel("Foreword",
                       HTML('<center><span style= color:rgb(142,0,0)><font face=Calibri size=6>Portuguese current and capital account</center> </font></span>'),
  ...
  sidebarLayout(
    ...
    #  helpText('Select a time period:'),
     ...
     # tags$style(HTML(".js-irs-0 .irs-single, .js-irs-0 .irs-bar-edge, .js-irs-0 .irs-bar {background: #8E0000}")),
       ...
       sliderInput("dates", "Select a time period:",
                  min = 1996, max = 2018,
                  sep = "",
                  ticks=FALSE,
                  value = c(1996,2018)),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),
      ...
      plotlyOutput("distPlot", width = "100%", height="350px"),br(), HTML('<span style = color:rgb(128,128,128)>Data source: Banco de Portugal, April 2019 <a href="https://www.bportugal.pt/EstatisticasWeb/(S(iczvpy45y4bm4r45n2n55045))/DEFAULT.ASPX?Lang=en-GB">Click here</a> <div>Methodological source: Balance of Payments and International Investment Position Manual, Sixth Edition (BPM 6), 2009 <a href="https://www.imf.org/external/pubs/ft/bop/2007/pdf/bpm6.pdf">Click here</a></span></div>')
             ...
             sidebarLayout(
               sidebarPanel(
                 ...
                 # Slider to select the years 
                 sliderInput("mapdates", "Select a time period:",
                             min = 1996, max = 2018,
                             value = 2018, step=1,
                             ticks=FALSE,
                             sep = "",
                ...
                selectInput('mapvariable','Select an item:',
...
<br><br>
           ...
           mainPanel(
             ...
             HTML('The map below represents, for the item/year selected, the relative value of each country in the world context. The relative position of the counterpart economy was defined in terms of quartiles:
       <li style=margin-left:2em>    <strong>High </strong> (<strong><span style = color:rgb(35,132,67)>dark green colour</span></strong>) - country has relatively larger values when compared with the other countries; top 25% of the world (fourth quartile); </li>
   ...
   <li style=margin-left:2em>       <strong>Very low </strong> (<strong><span style = color:rgb(227,194,145)>yellow colour</span></strong>) - country has relatively lower values when compared with the other countries; bottom 25% of the world (first quartile). </li>
     '),
             plotOutput("map",width = "100%", height="550px"), HTML('<span style = color:rgb(128,128,128)>Data source: Banco de Portugal, April 2019 <a href="https://www.bportugal.pt/EstatisticasWeb/(S(iczvpy45y4bm4r45n2n55045))/DEFAULT.ASPX?Lang=en-GB">Click here</a> <div>Methodological source: Balance of Payments and International Investment Position Manual, Sixth Edition (BPM 6), 2009 <a href="https://www.imf.org/external/pubs/ft/bop/2007/pdf/bpm6.pdf">Click here</a></span></div>'))
  ...
  tabPanel("By monthly periodicity",
           sidebarLayout(
             sidebarPanel(
               width = 2,
               selectInput('heatmapvariable','Select an item:',
             ...
             mainPanel( 
               ...
               HTML("The heatmap below exhibits the value of the select item in terms of year/month (defined by the grid). The values are defined in millions of Euros and should be interpreted as a function of the colour saturation; ranges from <strong><span style = color:rgb(194,230,153)>light green</span></strong> (more negative values) to <strong><span style = color:rgb(17,104,58)>dark green</span></strong> (more positive values).
                  <br>  <br>
  ...
  tabPanel("By type of services",
           sidebarLayout(
             sidebarPanel(
               width = 2,
               sliderInput("bubledates", "Select a time period:",
                           min = 1996, max = 2018,
                           value = 2018, step=1,
                           ticks=FALSE,
                           sep = "",
                           animate =
                             animationOptions(interval = 700, loop = FALSE, playButton = icon('play', "fa-2x"),
                                              pauseButton = icon('pause', "fa-2x"))),
               radioButtons("rd_services",label = "Include:", choices = list("All types of services","All services except travel and transport")),
             ...
             mainPanel(   
               ...
               HTML('The graph below shows the evolution of exports/imports by type of service. 
...
exports greater than the imports (and vice-versa). You can find more about the services by moving the mouse over the bubble (tooltip).
               <br>  <br>      
  ...
  tabPanel("By international comparison",
           sidebarLayout(
             sidebarPanel(
               width = 2,
               sliderInput("internationaldates", "Select a time period:",
                           min = 2007, max = 2018,
                           value = 2018, step=1,
                           ticks=FALSE,
                           sep = "",
                           animate =
                             animationOptions(interval = 700, loop = FALSE, playButton = icon('play', "fa-2x"),
                                              pauseButton = icon('pause', "fa-2x"))),
            radioButtons("rd",label = "Comparing Portugal with:", choices = list("All European countries","PIGS**","EU entry after 2004")),
            br(),br(),br(),
            HTML("<p align=right><font size=3><span style= color:rgb(142,0,0)><strong>Did you know that...</strong></font></span>
                 <br><br><em><font size=2><span style= color:rgb(72,72,72)>
...
<br><br>In the graph below it is possible to compare the Portuguese economy (<span style = color:rgb(142,0,0)><strong>red bar</strong></span>) with other European countries.
                  "),br(),br(),br(),
...
server <- function(input, output) {
  ...
  # colourPalette <- (brewer.pal(9,'RdYlGn'))
   ...
   output$heatmap <-  renderPlotly({
     ...
     plot_ly(x=colnames(heat_cca_n), y=rownames(heat_cca_c),z = heat_cca_n_matrix,colors =colourPalette, type = "heatmap")%>%
